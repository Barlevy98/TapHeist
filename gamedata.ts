...
export const WORLDS: World[] = [
  { 
    id: 'darknet', name: 'DARKNET (DEFAULT)', currency: 'cash', price: 0, 
    bg: '#050505', vaultRing: '#1A1A1A', textPrimary: '#FFFFFF', textSecondary: '#666666' 
  },
  { 
    id: 'retro', name: 'RETRO ARCADE', currency: 'cash', price: 3000, 
    bg: '#120424', vaultRing: '#4B0082', textPrimary: '#FF007F', textSecondary: '#39FF14' 
  },
  { 
    id: 'arctic', name: 'ARCTIC LAB', currency: 'cash', price: 8000, 
    bg: '#F2F2F7', vaultRing: '#D1D1D6', textPrimary: '#1C1C1E', textSecondary: '#8E8E93' 
  },
  { 
    id: 'cyber', name: 'CYBERPUNK NEON', currency: 'diamond', price: 750, 
    bg: '#0A001F', vaultRing: '#2A0080', textPrimary: '#00FFFF', textSecondary: '#FF00FF' 
  },
  { 
    id: 'blood', name: 'BLOOD MOON', currency: 'diamond', price: 1500, 
    bg: '#1A0000', vaultRing: '#330000', textPrimary: '#FF3B30', textSecondary: '#800000' 
  },
  { 
    id: 'nebula', name: 'DEEP NEBULA', currency: 'diamond', price: 4000, 
    bg: '#020210', vaultRing: '#0D1B2A', textPrimary: '#E0AA3E', textSecondary: '#415A77' 
  },
];
